...
namespace LocalSqsSnsMessaging.Http.Internal;
...
internal sealed class ArrayBufferWriter<T> : System.Buffers.IBufferWriter<T>
{
    ...
    {
        throw new InvalidOperationException("Cannot advance past the end of the buffer of size " + capacity + ".");
    }

    private static void ThrowOutOfMemoryException(uint capacity)
    {
        throw new OutOfMemoryException("Unable to allocate a buffer of size " + capacity + ".");
    }
}
#endif
