...
public static MemoryStream Write(ListSubscriptionsByTopicResponse response)
{
    ...
    utf8XmlWriter.WriteStartElement("ListSubscriptionsByTopicResult"u8);
        ...
        public static extern bool IsSetNextToken(ListSubscriptionsByTopicResponse response);

        [UnsafeAccessor(UnsafeAccessorKind.Method, Name = nameof(IsSetSubscriptions))]
        public static extern bool IsSetSubscriptions(ListSubscriptionsByTopicResponse response);
    }
}
