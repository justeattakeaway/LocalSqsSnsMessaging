...
{
    public static class GetEndpointAttributesResponseXmlWriter
    {
public static MemoryStream Write(GetEndpointAttributesResponse response)
{
    Debug.Assert(response is not null);
    var memoryStream = MemoryStreamFactory.GetStream(nameof(GetEndpointAttributesResponse));
    using var utf8XmlWriter = new Utf8XmlWriter((IBufferWriter<byte>)memoryStream);

    utf8XmlWriter.WriteStartElement("GetEndpointAttributesResponse"u8, "https://sns.amazonaws.com/doc/2010-03-31/"u8);

    utf8XmlWriter.WriteStartElement("GetEndpointAttributesResult"u8);
        ...
        public static extern bool IsSetAttributes(GetEndpointAttributesResponse response);
    }
}
