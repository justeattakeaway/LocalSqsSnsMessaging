...
{
    public static class ConfirmSubscriptionResponseXmlWriter
    {
public static MemoryStream Write(ConfirmSubscriptionResponse response)
{
    Debug.Assert(response is not null);
    var memoryStream = MemoryStreamFactory.GetStream(nameof(ConfirmSubscriptionResponse));
    using var utf8XmlWriter = new Utf8XmlWriter((IBufferWriter<byte>)memoryStream);

    utf8XmlWriter.WriteStartElement("ConfirmSubscriptionResponse"u8, "https://sns.amazonaws.com/doc/2010-03-31/"u8);

    utf8XmlWriter.WriteStartElement("ConfirmSubscriptionResult"u8);
        ...
        public static extern bool IsSetSubscriptionArn(ConfirmSubscriptionResponse response);
    }
}
