...
{
    public static class GetSMSAttributesResponseXmlWriter
    {
public static MemoryStream Write(GetSMSAttributesResponse response)
{
    Debug.Assert(response is not null);
    var memoryStream = MemoryStreamFactory.GetStream(nameof(GetSMSAttributesResponse));
    using var utf8XmlWriter = new Utf8XmlWriter((IBufferWriter<byte>)memoryStream);

    utf8XmlWriter.WriteStartElement("GetSMSAttributesResponse"u8, "https://sns.amazonaws.com/doc/2010-03-31/"u8);

    utf8XmlWriter.WriteStartElement("GetSMSAttributesResult"u8);
        ...
        public static extern bool IsSetAttributes(GetSMSAttributesResponse response);
    }
}
